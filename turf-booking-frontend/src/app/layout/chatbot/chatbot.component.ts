...
<title>Action</title>
          ...
          <div class="header-actions">
            ...
            <!-- Close icon button -->
            <button class="btn-header-action close-btn" (click)="toggleChat()" title="Close">
        ...
        <div class="chat-messages" #scrollContainer>
          ...
          >
            ...
            <div class="message-avatar" *ngIf="msg.sender === 'bot'" title="Action">
              <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M12 2a10 10 0 0 1 10 10c0 5.523-4.477 10-10 10S2 17.523 2 12A10 10 0 0 1 12 2z"></path>
                <path d="M8 10h.01"></path>
                <path d="M16 10h.01"></path>
...
<title>Expand</title>
          ...
          <div class="message-row bot-row" *ngIf="isTyping()">
            <div class="message-avatar" title="Action">
              <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M12 2a10 10 0 0 1 10 10c0 5.523-4.477 10-10 10S2 17.523 2 12A10 10 0 0 1 12 2z"></path>
                <path d="M8 10h.01"></path>
                <path d="M16 10h.01"></path>
        ...
        <form (submit)="sendMessage($event)" class="chat-input-form">
          <input 
            ...
            autocomplete="off"
          />
          <button type="submit" [disabled]="!userInput.trim() || isTyping()" aria-label="Send message" title="Action">
            <svg  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
