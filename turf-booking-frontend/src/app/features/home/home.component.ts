...
@Component({
 ...
 <div class="animate-fade-in-up animation-delay-300 flex flex-col items-center gap-4 mt-4">
 <a routerLink="/dashboard" class="hero-btn-primary w-full text-center font-cabin text-[16px] active:scale-95">
 Go to Dashboard
 </a>
 <a routerLink="/bookings" class="hero-btn-secondary w-full text-center font-cabin text-[16px] active:scale-95">
 My Bookings
 </a>
 </div>
 </div>
