...
@Component({
 ...
 <div class="bg-[var(--glass-bg)] border border-[var(--glass-border)] backdrop-blur-xl p-4 rounded-[24px] shadow-2xl max-w-md w-full text-center animate-fade-in-up">
 ...
 <app-sparkles-text text="Welcome to TurfXpert" className="text-2xl .1rem] whitespace-nowrap font-bold bg-clip-text text-transparent bg-gradient-to-r from-[var(--text-primary)] to-[var(--primary)] mb-3 font-inter tracking-tight"></app-sparkles-text>
 
 <p class="text-[var(--text-secondary)] mb-4 text-[0.95rem] leading-relaxed px-2">
