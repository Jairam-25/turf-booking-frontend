...
const content = `import { Component, EventEmitter, Input, Output, OnInit, signal, inject } from '@angular/core';
...
`;
fs.writeFileSync('src/app/features/auth/register/ui/register-form.component.ts', content);
console.log('Updated register-form.component.ts');
